...
birthDate) {
    ...
    periods.push({
        ...
        antardashas: calculateAntardashas(birthNakshatraLord, currentDate, firstEndDate, positionInNakshatra // Start from current position
        ),
    });
 ...
 */
function calculateAntardashas(mahadashaLord, startDate, endDate, startOffset = 0 // 0-1, how much of first antardasha has elapsed
) {
    const mahadashaYears = exports.DASHA_YEARS[mahadashaLord];
