...
// ═════════════════════════════════════════════════════════════════════════
function buildKimiPromptForCandidate(candidate, astrologicalReport, lifeEvents) {
    return `
...
// ═════════════════════════════════════════════════════════════════════════
function parseKimiResponse(response, candidate) {
...
exports.default = analyzeTopCandidatesWithKimi;
//# sourceMappingURL=kimi-k2-thinking-client.js.map