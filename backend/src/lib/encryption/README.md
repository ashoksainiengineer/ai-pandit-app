...
```typescript
import { encryptObject, decryptObject } from './encryption/index.js';
...
```typescript
import { safeEncrypt, safeDecrypt, isEncrypted } from './encryption/index.js';
