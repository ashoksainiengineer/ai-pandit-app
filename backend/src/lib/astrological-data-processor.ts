...
function generateNatalChartReport(ephemerisData: EphemerisData): string {
...
function generatePlanetaryAnalysis(ephemerisData: EphemerisData): string {
...
function generateHouseAnalysis(ephemerisData: EphemerisData): string {
...
function generateDashaAnalysis(ephemerisData: EphemerisData, lifeEvents: LifeEvent[]): string {
...
function generateTransitAnalysis(ephemerisData: EphemerisData, lifeEvents: LifeEvent[]): string {
...
function generateEventCorrelations(ephemerisData: EphemerisData, lifeEvents: LifeEvent[]): string {
