...
// Total: 22 questions across 6 categories
...
export const QUIZ_METADATA = {
  ...
  categories: [
    { id: 'prakriti', name: 'Body Constitution', questions: 5, icon: '🍃' },
    { id: 'facial', name: 'Facial Features', questions: 4, icon: '👁️' },
    { id: 'voice', name: 'Voice & Speech', questions: 4, icon: '🗣️' },
    { id: 'behavior', name: 'Behavior Patterns', questions: 5, icon: '🧠' },
    { id: 'marks', name: 'Physical Marks', questions: 2, icon: '🔴' },
    { id: 'family', name: 'Family Context', questions: 2, icon: '👨‍👩‍👧‍👦' }
  ]
};
