                ...
                <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-[#636363] leading-relaxed">
                            <span className="font-medium text-[#000000]">Multi-layered mathematical reduction.</span> The engine converges across
                            <span className="font-medium text-[#000000]"> 16 primary divisional charts</span> to find the singular rectified second of birth.
                        </p>
                    </div>
                    <motion.div
                ...
                {isExpanded && (
                    ...
                    >
                            ...
                            {activeTab === 'blueprint' && (
                                ...
                                >
                                    <div className="p-4 bg-gradient-to-br from-[#000000]/10 to-[#000000]/10 rounded-xl border border-[#000000]/20">
                                        <h4 className="font-medium text-[#000000] mb-2 flex items-center gap-2 text-sm">
                                    ...
                                    <div className="relative pl-6 space-y-4 before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-0.5 before:bg-[rgba(0,0,0,0.08)]">
                                        {[
                                            ...
                                            <div key={i} className="relative">
                                                ...
                                                <div>
                                                    <div className="text-[10px] font-medium text-[#000000] uppercase">{step.step}</div>
                                                    <div className="text-xs font-medium text-[#000000]">{step.label}</div>
                                                    <p className="text-[10px] text-[#636363] mt-0.5">{step.desc}</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                        ...
                                        <div key={idx} className="p-3 bg-white rounded-xl border border-[rgba(0,0,0,0.08)] flex gap-3">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center justify-between">
                                                    <h5 className="font-medium text-xs text-[#000000]">{item.layer}</h5>
                                                    <span className="text-[9px] font-mono text-[#000000] font-medium uppercase">{item.varga}</span>
                                                </div>
                                                <p className="text-[11px] text-[#636363] mt-1">{item.logic}</p>
                                            </div>
                                        </div>
                                    ))}
                                </motion.div>
                                ...
                                >
                                    <div className="grid grid-cols-2 gap-3">
                                        ...
                                        <div className="p-3 bg-black/[0.02] rounded-lg border border-black/5">
                                            ...
                                            <div className="font-mono text-[11px] font-medium text-[#000000]">Chain-of-Thought</div>
                                        </div>
                                        <div className="p-3 bg-black/[0.02] rounded-lg border border-black/5">
                                    ...
                                    <div className="p-3 bg-stone-50 rounded-xl border border-stone-200">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center justify-between text-[10px]">
                                                ...
                                                <span className="font-mono font-medium text-[#000000]">Enabled (v2.1)</span>
                                            </div>
                                            <div className="flex items-center justify-between text-[10px]">
                        ...
                        <div className="p-4 bg-gradient-to-r from-[#000000]/10 to-[#000000]/10 border-t border-[#000000]/20">
                            <p className="text-xs text-center text-[#636363] italic">
