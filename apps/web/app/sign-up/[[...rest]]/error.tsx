...
export default function SignUpError({
  ...
  useEffect(() => {
    logger.error('Sign-up page error:', error);
  }, [error]);

  return (
    <main className="min-h-screen bg-[var(--prism-canvas)] flex items-center justify-center">
      <div className="text-center px-4">
        <h1 className="text-2xl font-medium text-black mb-2">Sign-up unavailable</h1>
        <p className="text-[#636363] mb-6">Please try again or return home</p>
