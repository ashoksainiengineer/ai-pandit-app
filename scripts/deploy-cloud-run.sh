...
case "$SERVICE_KIND" in
   api)
     ...
     EXTRA_VARS="DB_POOL_MAX=10,NODE_ENV=production,APP_REGION=${REGION},CLOUD_RUN_REGION=${REGION},JOB_EXECUTION_MODE=external_worker,USE_ASYNC_JOB_PIPELINE=${USE_ASYNC_JOB_PIPELINE:-true},USE_NEW_STREAM_PATH=${USE_NEW_STREAM_PATH:-true},AI_BASE_URL=${AI_BASE_URL:-https://api.deepseek.com},AI_MODEL=${AI_MODEL:-deepseek-reasoner},AI_REASONING_MODE=${AI_REASONING_MODE:-include_reasoning},AI_PARALLEL_CONCURRENCY=${AI_PARALLEL_CONCURRENCY:-5},AI_STAGE2_MAX_TOKENS=${AI_STAGE2_MAX_TOKENS:-32768},AI_STAGE4_MAX_TOKENS=${AI_STAGE4_MAX_TOKENS:-32768},AI_STAGE6_MAX_TOKENS=${AI_STAGE6_MAX_TOKENS:-32768},EPHEMERIS_PROVIDER=${EPHEMERIS_PROVIDER:-skyfield},EPHEMERIS_ALLOW_ALGORITHMIC_FALLBACK=${EPHEMERIS_ALLOW_ALGORITHMIC_FALLBACK:-false},EPHEMERIS_SERVICE_URL=http://ephemeris-service,EPHEMERIS_SERVICE_TIMEOUT_MS=${EPHEMERIS_SERVICE_TIMEOUT_MS:-15000},EPHEMERIS_BATCH_SIZE=${EPHEMERIS_BATCH_SIZE:-250},EPHEMERIS_HOUSE_SYSTEM=${EPHEMERIS_HOUSE_SYSTEM:-whole_sign},REDIS_TLS=${REDIS_TLS:-true},FRONTEND_URL=${FRONTEND_URL},ALLOWED_ORIGINS=${ALLOWED_ORIGINS}"
